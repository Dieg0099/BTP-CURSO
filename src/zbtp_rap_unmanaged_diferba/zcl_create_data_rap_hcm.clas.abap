CLASS zcl_create_data_rap_hcm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_create_data_rap_hcm IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM zhcm_m_diferba.

    MODIFY zhcm_m_diferba FROM @( VALUE #( e_number = '00000001'
                                           e_name   = 'Lorena Perez'
