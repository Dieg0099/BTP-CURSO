CLASS lcl_buffer DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    TYPES: BEGIN OF ty_buffer.
             INCLUDE TYPE zhcm_m_diferba AS data.
...
CLASS lhc_HCM IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities INTO DATA(ls_entities).
      ...
      SELECT SINGLE * FROM zhcm_m_diferba
...
CLASS lsc_ZHCM_R_DIFERBA DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZHCM_R_DIFERBA IMPLEMENTATION.
  ...
  METHOD save.
    ...
    DATA: lt_data_created TYPE STANDARD TABLE OF zhcm_m_diferba,
          lt_data_updated TYPE STANDARD TABLE OF zhcm_m_diferba,
          lt_data_deleted TYPE STANDARD TABLE OF zhcm_m_diferba.
...
* Create
    ...
    IF lt_data_created IS NOT INITIAL.
      INSERT zhcm_m_diferba FROM TABLE @lt_data_created.
    ENDIF.
...
* Update
    ...
    IF lt_data_updated IS NOT INITIAL.
      UPDATE zhcm_m_diferba FROM TABLE @lt_data_updated.
    ENDIF.
...
* Delete
    ...
    IF lt_data_deleted IS NOT INITIAL.
      DELETE zhcm_m_diferba FROM TABLE @lt_data_deleted.
    ENDIF.
